...
export const FRAME_DESIGNS = [
  ...
  },
  {
    slug: "cloud-nest",
    name: "Cloud Nest",
    subtitle: "The Little Pilot",
    image: CLOUDINARY.cloudNest,
    imageAlt: "Cloud Nest little pilot bear nameplate frame",
  },
  {
    slug: "little-roots",
    name: "Little Roots",
    subtitle: "Tree of Love",
  ...
  },
  {
    ...
    imageAlt: "Memory Nest personalized birth announcement frame with crochet boy doll",
  },
  {
    slug: "welcome-to-the-world",
    name: "Welcome to the World",
    subtitle: "Lion or Bear",
    image: CLOUDINARY.welcomeToTheWorld,
    imageAlt: "Welcome to the World personalized crochet birth announcement frame",
  },
  {
    slug: "little-curve",
    name: "Little Curve",
    subtitle: "Semi Cloud",
    image: CLOUDINARY.littleCurve,
    imageAlt: "Little Curve cloud frame with a crochet doll and name plaque",
  },
  {
    slug: "little-meadow",
    name: "The Little Meadow Frame",
    subtitle: "Half Cloud with Bunny",
    image: CLOUDINARY.littleMeadow,
    imageAlt: "Little Meadow half-cloud frame with a crochet bunny",
  },
  {
    slug: "little-world",
    name: "The Little World Frame",
    subtitle: "Doll and Puppy",
    image: CLOUDINARY.littleWorld,
    imageAlt: "Little World cloud frame with a crochet doll and puppy",
  },
  {
    slug: "rattan-heart",
    name: "Rattan Heart",
