...
export const frameProducts: SeedProduct[] = [
  ...
  },
  {
    ...
    imageAlt:
      "Memory Nest personalized birth announcement frame with crochet boy doll and balloons",
    price: 3199,
    isFeatured: true,
    sortOrder: 4,
  },
  {
    ...
    imageAlt:
      "Welcome to the World personalized crochet lion birth announcement frame",
    price: 3299,
    isFeatured: true,
    sortOrder: 5,
  },
  {
    slug: "little-curve",
    name: "Little Curve",
    tagline: "Semi cloud nursery frame",
    description:
      "Little Curve brings a gentle semi-cloud silhouette to your nursery wall — soft curves and a dreamy palette designed to frame your little one's first milestones and forever memories.",
    material: "Handcrafted frame",
    size: "Nursery wall frame",
    ageRange: null,
    features: [
      "Semi-cloud curved silhouette design",
      "Soft, dreamy nursery aesthetic",
      "Ideal for personalized birth announcements",
      "Customizable through Frame It Your Way",
    ],
    careInstructions: [...FRAME_CARE],
    images: [
      CLOUDINARY.littleCurve,
      CLOUDINARY.littleCurveAlt,
      CLOUDINARY.littleCurveThird,
    ],
    imageAlt: "Little Curve semi cloud nursery frame",
    price: 3299,
    isFeatured: false,
    sortOrder: 6,
  },
