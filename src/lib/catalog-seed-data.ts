...
export const frameProducts: SeedProduct[] = [
  ...
  },
  {
    slug: "cloud-nest",
    name: "Cloud Nest",
    tagline: "The Little Pilot — Personalized Crochet Nameplate Frame",
    description:
      "Up, up and away.\n\nNestled inside a soft cloud-shaped frame sits our little pilot bear — complete with an aviator cap, a cozy scarf, and two balloons trailing behind him, ready for takeoff. Below him, your little one's name takes flight in bold script — because every child deserves to feel like the hero of their own adventure.\n\nEvery stitch, from the balloon strings to the tiny scarf fringes, is crocheted entirely by hand — no two pilots are ever quite the same.\n\nPerfect for nurseries, baby showers, birthday gifts, or that one wall waiting for a little adventure to begin. Handmade with care. Made to be kept.",
    material: "Sturdy cloud-shaped wooden frame",
    size: "Nursery wall frame",
    ageRange: null,
    features: [
      "Fully personalized with your child's name",
      "Hand-crocheted pilot bear with balloon details — no two pieces identical",
      "Sturdy cloud-shaped wooden frame, ready to hang",
      "A nursery keepsake that feels like the start of a story",
    ],
    careInstructions: [...FRAME_CARE],
    images: [CLOUDINARY.cloudNest],
    imageAlt: "Cloud Nest little pilot bear nameplate in a cloud-shaped frame",
    price: 3999,
    isFeatured: true,
    sortOrder: 2,
  },
  {
    slug: "little-roots",
    name: "Little Roots",
    tagline: "Personalized Crochet Tree of Love Frame",
    description:
      "Turn a child's name into a beautiful little story with our Personalized Crochet Tree of Love Frame — a handcrafted keepsake designed to bring warmth, colour, and childhood magic to any room.\n\nFeaturing a charming wooden tree, delicate crochet leaves and flowers, and adorable handmade crochet animals sitting around the branches, every detail adds a playful touch. The personalized name plaque makes it truly special and one-of-a-kind.\n\nA little tree, a little magic, and a whole lot of love — made especially for your little one.\n\nTree of Memories brings a little piece of childhood magic to your little one's room. A beautiful combination of handcrafted crochet details and a natural wooden tree, this frame is designed to feel like a tiny world made especially for your child. The frame features a wooden tree decorated with crochet leaves, delicate pink flowers and butterflies, while adorable handmade crochet characters sit at its base. Colourful crochet balloons add a playful touch, and the personalized name makes the keepsake truly unique.\n\nA little tree filled with flowers, friends, and memories — made to celebrate your little one's beautiful beginning.",
    material: "Wooden tree with handcrafted crochet details",
    size: "Nursery wall frame",
    ageRange: null,
    features: [
      "Beautiful wooden tree design",
      "Handcrafted crochet flowers, leaves, and butterflies",
      "Cute crochet animal characters",
      "Personalized with your child's name",
      "Tree of Memories adds handmade crochet balloons and a white shadow-box frame",
      "Perfect for nurseries, kids' rooms, birthdays, and baby gifting",
    ],
    careInstructions: [...FRAME_CARE],
    images: [
      CLOUDINARY.littleRoots,
      CLOUDINARY.littleRootsAlt,
      CLOUDINARY.littleRootsThird,
    ],
    imageAlt: "Little Roots personalized crochet tree frame",
    price: 4199,
    isFeatured: false,
    sortOrder: 3,
    variants: [
      ...
      {
        slug: "tree-of-love-ii",
        name: "Tree of Love II",
        price: 4599,
        sortOrder: 2,
        images: [CLOUDINARY.littleRootsAlt],
      },
      {
        slug: "tree-of-memories",
        name: "Tree of Memories",
        price: 5999,
        sortOrder: 3,
        images: [CLOUDINARY.littleRootsThird],
      },
    ],
  },
  {
    slug: "memory-nest",
    name: "Memory Nest",
    tagline: "Every little detail, made to be remembered.",
    description:
      "A hand-crocheted baby doll holds a bunch of balloons beside a keepsake birth card — complete with space to note the date, time, and weight that marked the start of it all. Soft blooms line the bottom, and your baby's name rests just below, ready to greet the world. Choose a baby boy doll or a baby girl doll.\n\nFrom the tiny dungarees to the balloon strings, everything is crocheted entirely by hand — a one-of-a-kind welcome for a one-of-a-kind arrival.\n\nPerfect for newborn gifts, baby showers, birth announcements, or the first thing that goes up on the nursery wall. Handmade with care. Made to be kept.",
    material: "Deep wooden shadow-box frame",
    size: "Nursery wall frame",
    ageRange: null,
    features: [
      "Fully personalized with baby's name and birth details",
      "Hand-crocheted baby doll and floral details — no two pieces identical",
      "Deep wooden shadow-box frame, ready to hang",
      "A newborn keepsake that captures the very first details of their story",
    ],
    careInstructions: [...FRAME_CARE],
    images: [CLOUDINARY.memoryNest],
    imageAlt:
      "Memory Nest personalized birth announcement frame with crochet baby doll and balloons",
    price: 4499,
    isFeatured: true,
    sortOrder: 4,
    variants: [
  ...
  },
  {
    ...
    tagline: "Personalized Crochet Birth Announcement Frame",
    description:
      "A handcrafted keepsake to celebrate your little one's arrival. This mint-green MDF frame features an adorable hand-crocheted companion — a lion or a bear — perched beside colorful crochet balloons.\n\nThe frame is fully personalized with baby's name in elegant script lettering, plus space to note the date of birth, time of birth, and baby's birth weight.\n\nFinished with a charming \"Welcome to the World\" print background, this piece doubles as nursery décor and a forever memento of the day your baby was born — handmade with love, designed to be treasured.",
    material: "Mint-green MDF frame with hand-crocheted details",
    size: "Nursery wall frame",
    ageRange: null,
    features: [
      "Hand-crocheted lion or bear with colorful crochet balloons",
      "Personalized with baby's name in elegant script lettering",
      "Space for date of birth, time of birth, and birth weight",
      "Charming \"Welcome to the World\" print background",
      "Nursery décor and forever memento in one",
    ],
    careInstructions: [...FRAME_CARE],
    images: [CLOUDINARY.welcomeToTheWorld],
    imageAlt:
      "Welcome to the World personalized crochet birth announcement frame",
    price: 3099,
    isFeatured: true,
    sortOrder: 5,
    variants: [
  ...
  },
  {
    slug: "little-curve",
    name: "Little Curve",
    tagline: "A little cloud, made just for them.",
    description:
      "Nestled inside a hand-carved cloud frame is a curly-haired crochet doll, surrounded by hand-stitched flowers, a fluttering butterfly, and a name plaque below — because this isn't just décor, it's a small universe made in their name. Choose the version made just for her, or the version made just for him.\n\nEvery doll, every petal, every curl is crocheted by hand — no two are ever quite the same, just like the little one it's made for.\n\nPerfect for nurseries, birthday gifts, naming ceremonies, or that one wall that's still waiting for something meant just for them. Handmade with care. Made to be kept.",
    material: "Sturdy cloud-shaped wooden frame",
    size: "Nursery wall frame",
    ageRange: null,
    features: [
      "Fully personalized with your child's name",
      "Hand-crocheted doll and floral details — no two pieces identical",
      "Sturdy cloud-shaped wooden frame, ready to hang",
      "A keepsake that grows into a memory, not just a gift",
    ],
    careInstructions: [...FRAME_CARE],
    images: [CLOUDINARY.littleCurve],
    imageAlt: "Little Curve cloud frame with a crochet doll and name plaque",
    price: 3999,
    isFeatured: true,
    sortOrder: 6,
    variants: [
  ...
  {
    slug: "little-meadow",
    name: "The Little Meadow Frame",
    tagline: "Personalized Nameplate Set — Half Cloud with Bunny",
    description:
      "Somewhere in a garden that only exists in cloud-shaped frames, a little bunny sits waiting.\n\nPink-eared and rosy-cheeked, she's tucked into a bed of hand-crocheted blooms — buttery yellows, soft blush pinks, warm creams — each one looped, petal by petal, by hand. A tiny butterfly rests just above, mid-flutter, forever.\n\nBeside her garden, a name — written the way you'd write it in a card you meant to keep forever.\n\nNot a toy. Not decor. A little meadow that says this corner is yours, made stitch by stitch for the ones who'll outgrow everything except this.\n\nHandmade in India. Made to be kept, not just displayed.",
    material: "Half cloud wooden frame with hand-crocheted details",
    size: "Nursery wall frame",
    ageRange: null,
    features: [
      "Hand-crocheted bunny in a garden of blooms",
      "Personalized name beside the meadow",
      "Half-cloud frame, ready to hang",
      "Handmade in India",
    ],
    careInstructions: [...FRAME_CARE],
    images: [CLOUDINARY.littleMeadow],
    imageAlt: "Little Meadow half-cloud frame with a crochet bunny and flowers",
    price: 3299,
    isFeatured: true,
    sortOrder: 8,
  },
  {
    slug: "little-world",
    name: "The Little World Frame",
    tagline: "Some corners of a room are just for one little person.",
    description:
      "Some corners of a room are just for one little person. This is that corner, made real.\n\nA cloud-soft frame holds it all — a hand-crocheted doll, a floppy-eared puppy keeping watch beside them, and a garden of tiny flowers that never wilts. Every strand looped by hand, every face stitched with more patience than pattern. Choose the version made for her, or the version made for him.\n\nBeside it, their name — in flowing script, unmistakably theirs.\n\nNot a toy. Not decor. A little world that says this space belongs to you, stitched thread by thread, for the people who'll remember it long after the room changes.\n\nHandmade in India. Made to be kept, not just displayed.",
    material: "Cloud-soft wooden frame with hand-crocheted details",
    size: "Nursery wall frame",
    ageRange: null,
    features: [
      "Hand-crocheted doll with a floppy-eared puppy",
      "Garden of tiny crochet flowers",
      "Personalized name in flowing script",
      "Handmade in India",
    ],
    careInstructions: [...FRAME_CARE],
    images: [CLOUDINARY.littleWorld],
    imageAlt:
      "Little World cloud frame with a crochet doll, puppy, and name plaque",
    price: 4999,
    isFeatured: true,
    sortOrder: 9,
    variants: [
